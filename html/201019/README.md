...
- HTML5의 콘텐츠 모델(content model)
  ...
  ##### 참고 2) https://developer.mozilla.org/ko/docs/Web/Guide/HTML/Content_categories
...
- 설계
  ...
  - 마크업 과정
    ...
    3. 시맨틱 마크업
      ...
      - HTML5 이전에는 div 또는 span, 즉 의미가 없는 태그들을 사용하여 구획을 나누었는데, 이는 어떤 용도로 사용된 것인지 알기가 쉽지 않았고 복잡해지는 단점이 있었음.

    4. 네이밍

      - 영어권의 trendy한 naming을 따를 것을 권장함.
      
      - 재사용 가치가 있는 것들이 무엇일지를 고민하며 네이밍하는 습관을 들일 것
